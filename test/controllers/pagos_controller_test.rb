...
class PagosControllerTest < ActionController::TestCase
  ...
  test "should create pago" do
    assert_difference('Pago.count') do
      post :create, pago: { cliente_id: @pago.cliente_id, descripcion: @pago.descripcion, factura: @pago.factura, iva: @pago.iva, neto: @pago.neto, proyecto_id: @pago.proyecto_id }
    end
  ...
  test "should update pago" do
    patch :update, id: @pago, pago: { cliente_id: @pago.cliente_id, descripcion: @pago.descripcion, factura: @pago.factura, iva: @pago.iva, neto: @pago.neto, proyecto_id: @pago.proyecto_id }
    assert_redirected_to pago_path(assigns(:pago))
  end
