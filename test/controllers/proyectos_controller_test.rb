...
class ProyectosControllerTest < ActionController::TestCase
  ...
  test "should create proyecto" do
    assert_difference('Proyecto.count') do
      post :create, proyecto: { lat_ubicacion: @proyecto.lat_ubicacion, lon_ubicacion: @proyecto.lon_ubicacion, nombre: @proyecto.nombre, obrero_id: @proyecto.obrero_id, presupuesto: @proyecto.presupuesto }
    end
  ...
  test "should update proyecto" do
    patch :update, id: @proyecto, proyecto: { lat_ubicacion: @proyecto.lat_ubicacion, lon_ubicacion: @proyecto.lon_ubicacion, nombre: @proyecto.nombre, obrero_id: @proyecto.obrero_id, presupuesto: @proyecto.presupuesto }
    assert_redirected_to proyecto_path(assigns(:proyecto))
  end
