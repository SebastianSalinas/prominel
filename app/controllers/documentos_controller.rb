class DocumentosController < ApplicationController
  ...
  def import
    Documento.import(params[:file])
    redirect_to documentos_url, notice: "Products imported."
  end
  ...
  private
    ...
    def documento_params
      params.require(:documento).permit(:cheque, :chequera, :valor, :proveedor, :fecha, :oocc, :factura, :centrocosto, :cobrado, :nulo, :nopago, :plazo)
    end
end
